<%@ Page Title="Bill Print" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="BillPrint.aspx.cs" Inherits="EMS.miu.bill.BillPrint" %>
...
<div>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:GridView ID="GvBillPrint"  runat="server"  AutoGenerateColumns="False" CssClass="table-bordered"
                EmptyDataText="No data found." AllowPaging="false" CellPadding="4" OnRowCommand="GvBillPrint_RowCommand" >
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    ...
                    <asp:BoundField DataField="BillingDate"  HeaderText="BillingDate" DataFormatString="{0:dd-MMM-yy}">
                     ...
                     <asp:TemplateField  HeaderText="Bill Print" >
                        <ItemTemplate >
                            <asp:Button ID="btnBillPrint" runat="server"  Text="Print" CommandName="BillPrint" CommandArgument='<%#Eval("BillHistoryMasterId")%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>

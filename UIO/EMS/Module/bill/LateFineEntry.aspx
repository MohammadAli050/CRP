<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" CodeBehind="LateFineEntry.aspx.cs" Inherits="EMS.miu.bill.LateFineEntry" %>
    ...
    <div style="padding: 5px; width: 100%;">
        ...
        <div class="Message-Area" style="height: 45px;">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div>
                        <table style="padding: 5px; width: 100%; height: 100px;">
                            <tr>
                                <td class="tbl-width-lbl"><b>Program</b></td>
                                <td>
                                    <uc1:ProgramUserControl runat="server" ID="ucProgram" OnProgramSelectedIndexChanged="OnProgramSelectedIndexChanged" />
                                </td>
                                <td class="auto-style1"><b>Registration Session</b></td>
                                <td>
                            ...
                            <tr>
                                <td class="tbl-width-lbl"><b>Posting Session</b></td>
                                <td><uc1:SessionUserControl runat="server" ID="ucPostSession"/></td>
                                <td class="auto-style1"><b>Fine Amount</b></td>
                                ...
                                <td class="tbl-width-lbl"><b>Remarks</b></td>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Apply">
                                <HeaderTemplate>
                                    <label>Apply</label>
                                    <hr />
                                    <asp:CheckBox ID="chkSelectAllLateFineEntry" runat="server" Text="All"
                                        AutoPostBack="true" OnCheckedChanged="chkSelectAllLateFineEntry_CheckedChanged" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div style="text-align: center">
                                        <asp:CheckBox runat="server" ID="ChkIsLateFineEntry" checked="false"></asp:CheckBox>
                                    </div>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />

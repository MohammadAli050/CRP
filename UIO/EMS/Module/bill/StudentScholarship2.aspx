<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="StudentScholarship2.aspx.cs" Inherits="EMS.miu.bill.StudentScholarship2" %>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td class="auto-style2">&nbsp</td>
                        <td class="auto-style11"><b>Credit :<b></td>
                        <td class="auto-style13">
                            <asp:TextBox ID="txtRegisterdCredit" runat="server" onkeypress="return onlyDotsAndNumbers(event)" Width="33px"></asp:TextBox>
                        </td>          
                    </tr>
                    <tr>

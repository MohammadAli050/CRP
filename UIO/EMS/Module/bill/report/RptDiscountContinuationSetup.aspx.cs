...
public partial class Report_RptDiscountContinuationSetup : BasePage
{
    ...
    {
        List<DiscountContinuationSetup> discountContinuationSetupList = DiscountContinuationSetupManager.GetAll(acaCalID, programId);
        
        ReportViewer1.LocalReport.DataSources.Clear();
        ReportDataSource rds = new ReportDataSource("DiscountContinuation", discountContinuationSetupList);

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptStudentWithMinimumDueAmount.aspx.cs" Inherits="EMS.miu.bill.report.RptStudentWithMinimumDueAmount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Student With Minimum Due Amount
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    <div class="PageTitle">
        <label>Due:: Student With Minimum Due Amount</label>
    </div>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td class="auto-style8"><b>Registration Session</b></td>
                            <td class="auto-style7"><uc1:SessionUserControl runat="server" ID="ucRegistrationSession" OnSessionSelectedIndexChanged="OnRegistrationSessionSelectedIndexChanged"/></td>                                                                                                                                                  
    ...
    <div>&nbsp;</div>
    <div>
    <rsweb:reportviewer ID="StudentWithMinimumDue" runat="server"  waitmessagefont-names="Verdana" waitmessagefont-size="14pt" asynrendering="true" width="90%" Height="100%" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" sizetoreportcontent="true" >
    </rsweb:reportviewer>
    </div>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="True" CodeBehind="AccountTypeStudentWiseBill2.aspx.cs" Inherits="AccountTypeStudentWiseBill2" %>

<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="Server">
    Account Wise Bill(Discount) Report
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
    <div class="PageTitle">
        <label>Bill(Discount) Report : : Account and Date Wise</label>
    </div>
                        ...
                        <table>
                            <tr>
                                <td class="auto-style5">
                                    <asp:Label ID="Label5" runat="server" Text="Account Type" Style="width: 90px; display: inline-block;"></asp:Label>

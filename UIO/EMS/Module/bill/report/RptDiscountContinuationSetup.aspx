<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" Inherits="Report_RptDiscountContinuationSetup" Codebehind="RptDiscountContinuationSetup.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
     <p>Student Discount Continuation</p>
    <table>
        <tr>
            <td>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" 
        ...
        <LocalReport ReportPath="miu/bill/report/DiscountContinuation.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

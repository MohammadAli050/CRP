<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptPeriodicalOrDaily .aspx.cs" Inherits="EMS.miu.bill.report.RptPeriodicalOrDaily" %>
                ...
                <div>
                    <table id="table1">
                        <tr>
                            ...
                            <td><b>Gender:</b></td>
                            <td>
                               <asp:CheckBox ID="chkBoxMale" runat="server" Text="Male" />
                               <asp:CheckBox ID="chkBoxFemale" runat="server" Text="Male" />
                            </td>
                            <td><b>Program:</b></td>
                            <td>
                                <asp:DropDownList ID="ddlProgram" Width="115" runat="server" OnSelectedIndexChanged="ddlProgram_SelectedIndexChanged" AutoPostBack="true">                    
                                </asp:DropDownList>
                            </td>
                            <td id="batch" style="visibility:hidden"><b>Batch:</b></td>
                            <td>
                                <uc2:BatchUserControlAll runat="server" ID="ucBatch" OnBatchSelectedIndexChanged="OnBatchSelectedIndexChanged" Visible="false" />
                            </td>
                        </tr>
                        <%--<tr>
                            <td><b>Program</b></td>

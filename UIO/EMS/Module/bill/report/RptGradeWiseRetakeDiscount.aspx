<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" Inherits="Report_RptGradeWiseRetakeDiscount" Codebehind="RptGradeWiseRetakeDiscount.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" 
        ...
        <LocalReport ReportPath="miu/bill/report/GradeWiseRetake.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>
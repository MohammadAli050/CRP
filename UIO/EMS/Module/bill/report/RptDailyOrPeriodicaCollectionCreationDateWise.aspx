<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptDailyOrPeriodicaCollectionCreationDateWise.aspx.cs" Inherits="EMS.miu.bill.report.RptDailyOrPeriodicaCollectionCreationDateWise" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    <div class="PageTitle">
        <label>Daily / Periodical Collection :: Date Wise</label>
    </div>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td><uc2:BatchUserControlAll runat="server" ID="ucBatch" OnBatchSelectedIndexChanged="OnBatchSelectedIndexChanged"/></td>
    ...
    <div>&nbsp;</div>
    <div>
    <rsweb:reportviewer ID="DailyOrPeriodicalCollection" runat="server"  waitmessagefont-names="Verdana" waitmessagefont-size="14pt" asynrendering="true" width="53%" Height="100%" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" sizetoreportcontent="true" >
    </rsweb:reportviewer>
    </div>
</asp:Content>

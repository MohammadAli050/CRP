<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="True" CodeBehind="RptDailyCollection.aspx.cs" Inherits="RptDailyCollection" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
                    ...
                    <div class="Message-Area">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnDailyCollection" runat="server" Text="Load" Width="150" OnClick="GetDailyCollection_Click"></asp:Button>
        ...
        <Animations>
            <OnUpdating>
               <Parallel duration="0">
                    ...
                    <EnableAction AnimationTarget="btnDailyCollection" Enabled="false" />                   
                </Parallel>
            </OnUpdating>
            <OnUpdated>
                <Parallel duration="0">
                    <ScriptAction Script="onComplete();" />
                    <EnableAction   AnimationTarget="btnDailyCollection" Enabled="true" />
                </Parallel>
            </OnUpdated>
        </Animations>
    ...
    <div>&nbsp;</div>
    <center>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" asynrendering="true" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" Height="100%" Width="62%" SizeToReportContent="true">
            <LocalReport ReportPath="miu\bill\report\RptDailyCollection.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </center>
</asp:Content>

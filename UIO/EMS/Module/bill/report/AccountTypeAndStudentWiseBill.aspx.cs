...
public partial class AccountTypeAndStudentWiseBill : BasePage
{
    ...
    protected void LoadBillHistory(int typeDefinationId,int programId, int batchId,int acaCalId,DateTime fromDate, DateTime toDate)
    {
        ...
        try
        {
            ...
            List<rBillHistoryFeeTypeWise> list = null; //BillHistoryManager.GetStudentBillHistoryFeeTypeWise(typeDefinationId, programId, batchId, acaCalId, fromDate, toDate);

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="RptCourseEvaluation" CodeBehind="RptCourseEvaluation.aspx.cs" %>
                        ...
                        <table style="padding: 5px; width: 100%;">
                            <tr>
                                ...
                                <td class="auto-style1">
                                    ...
                                    <asp:DropDownList ID="ddlTeacher" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTeacher_SelectedIndexChanged" Width="330px" />
                                </td>
                                <td class="auto-style5">
                                    <asp:Label ID="Label5" runat="server" Text="Course With Section"></asp:Label>
                                    <asp:DropDownList ID="ddlCourseWithSection" runat="server" Width="311px" />
                                </td>
                                <td>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="Report_Attendance" Codebehind="RptAttendance.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
    <div class="PageTitle">
        <label>Attandance Sheet :: Section Wise</label>
    </div>
                ...
                <div>
                    <table id="Table1" style="width: 101%; height: 25px;" runat="server">
                        <tr>
                            ...
                            <td class="auto-style11"><b>Column: </b></td>
                            <td class="auto-style12"><asp:DropDownList ID="ddlCol" runat="server" width="42px">
                                    <asp:ListItem Value="0">28</asp:ListItem>

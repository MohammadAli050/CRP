<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" CodeBehind="ExamScheduleSeatPlanManagementMixed.aspx.cs" Inherits="EMS.miu.schedular.ExamScheduleSeatPlanManagementMixed" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
    <div>
        ...
        <div class="PageTitle">
            <label>Exam Schedule(Mixed) Seat Plan</label>
        </div>
                        ...
                        <div class="information-Zone">
                            ...
                            <div class="loadedArea">
                                ...
                                <asp:Panel runat="server" ID="pnMaleFemaleCount">
                                    <label class="display-inline field-Title4">Total Student Count</label>
                                    <asp:TextBox runat="server" ID="txtStdCount" class="margin-zero input-Size" Enabled="false" Text="0" />
                                    &nbsp;</asp:Panel>
                            </div>
                        ...
                        <asp:Panel runat="server" ID="pnSectionAssign">
                            <div class="information-Zone2">
                                ...
                                <div class="loadedArea">
                                    ...
                                    <asp:Button runat="server" ID="btnMaleRoom" Text="Assign Room" OnClick="btnRoom_Click" class="button-margin btn-size2" />
                                    
                                </div>
                                <div class="loadedArea">
                                    <asp:ListBox runat="server" ID="lbMaleRoomList" CssClass="margin-zero maleListBoxStyle" />
                                    <asp:Button runat="server" ID="btnMaleRoomDelete" Text="Delete" OnClick="btnRoomDelete_Click" class="button-margin btn-size3" />
                                </div>
                            </div>
                        </asp:Panel>

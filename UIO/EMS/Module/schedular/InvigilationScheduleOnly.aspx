<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" 
    Inherits="InvigilationScheduleOnly" Codebehind="InvigilationScheduleOnly.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" Runat="Server">Invigilation Schedule</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
    <div>
        ...
        <div class="PageTitle">
            <label>Invigilation Schedule</label>
        </div>
                ...
                <div class="ExamScheduleSeatPlan-container">
                    <div class="div-margin">
                        <div class="information-Zone">
                            ...
                            <div class="loadedArea">
                                <asp:Button runat="server" ID="btnInvigilationScheduleDownload" Text="Load" OnClick="btnInvigilationScheduleDownload_Click" class="button-margin btn-size" />
                            </div>
                            <div hidden="hidden" class="loadedArea">

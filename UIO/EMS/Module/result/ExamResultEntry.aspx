<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" 
    CodeBehind="ExamResultEntry.aspx.cs" Inherits="EMS.miu.result.ExamResultEntry" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>


<asp:Content ID="Content1" ContentPlaceHolderID="Title" Runat="Server">Exam Result Entry</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function OnMarkFieldClick(id) {
            if (parseInt(document.getElementById(id).value) == 0)
                document.getElementById(id).value = '';

        }
        function InvokeSaveButton(idS) {
            FillZeroIfEmpty(idS);
            var str = idS.toString();
            var saveBtnID = str.substring(0, (idS.length - 8));
            var saveBtnID = saveBtnID.concat('lbSave');
            document.getElementById(saveBtnID).click();

        }

        function FillZeroIfEmpty(id) {
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
    ...
    <div class="auto-style1"><strong>&nbsp;&nbsp;&nbsp;&nbsp; *&nbsp; Teachers are suggested to enter marks column wise (e.g. &quot; Teacher&#39;s Assessment for all students first, then Mid for all students then final ...&quot;)</strong></div>
            ...
            <div class="ExamResultEntry-container">
                <div class="div-margin">
                    <div class="loadArea">
                        ...
                        <%--<div class="display-inline">
                            <label class="display-inline field-Title"></label><br />
                            <asp:Button ID="btnPrint" runat="server" Text="Print Result" class="button-margin btn-size" OnClick="btnPrint_Click" />
                        </div>--%>
                    </div>
                    <asp:Panel runat="server" ID="pnSubmitStudentMarkTop">
                        <div class="loadedArea">
                            <div class="SpecialForButton">
                                <asp:Button ID="btnSubmitAllStudentMarkTop" runat="server" Text="Save All Student Marks" class="button-margin btn-size1 floatLeft" OnClick="SubmitAllStudentMark_Click" />
                                <asp:Button ID="btnFinalSubmitTop" runat="server" Text="Final Submit" class="button-margin btn-size1 floatRight" OnClick="FinalSubmit_Click" OnClientClick="if (!confirm('Are you sure you want to Final Submit ?')) return false;" />
                        ...
                        <asp:gridview ID="gvExamResultSubmit" runat="server" AutoGenerateColumns="False" class="mainTable" onrowdatabound="gvExamResultSubmit_RowDataBound" >
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Mark" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate><asp:TextBox  onblur="InvokeSaveButton(this.id)" onclick="OnMarkFieldClick(this.id)" runat="server" ID="txtMark1"  Text='<%#Eval("Mark1")%>' class="margin-zero input-Size" /></ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Mark" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate><asp:TextBox onblur="InvokeSaveButton(this.id)"  onclick="OnMarkFieldClick(this.id)" runat="server" ID="txtMark2" Text='<%#Eval("Mark2")%>' class="margin-zero input-Size" /></ItemTemplate>
                                    <HeaderStyle Width="40px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Mark" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate><asp:TextBox onblur="InvokeSaveButton(this.id)"  onclick="OnMarkFieldClick(this.id)" runat="server" ID="txtMark3" Text='<%#Eval("Mark3")%>' class="margin-zero input-Size" /></ItemTemplate>
                                    <HeaderStyle Width="40px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Mark" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate><asp:TextBox onblur="InvokeSaveButton(this.id)"  onclick="OnMarkFieldClick(this.id)" runat="server" ID="txtMark4" Text='<%#Eval("Mark4")%>' class="margin-zero input-Size" /></ItemTemplate>
                                    <HeaderStyle Width="40px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Mark" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate><asp:TextBox onblur="InvokeSaveButton(this.id)"  onclick="OnMarkFieldClick(this.id)" runat="server" ID="txtMark5" Text='<%#Eval("Mark5")%>' class="margin-zero input-Size" /></ItemTemplate>
                                    <HeaderStyle Width="40px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Mark" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate><asp:TextBox  onblur="InvokeSaveButton(this.id)" onclick="OnMarkFieldClick(this.id)" runat="server" ID="txtMark6" Text='<%#Eval("Mark6")%>' class="margin-zero input-Size" /></ItemTemplate>
                                    <HeaderStyle Width="40px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Mark" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate><asp:TextBox onblur="InvokeSaveButton(this.id)"  onclick="OnMarkFieldClick(this.id)" runat="server" ID="txtMark7" Text='<%#Eval("Mark7")%>' class="margin-zero input-Size" /></ItemTemplate>
                                    <HeaderStyle Width="40px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
            ...
            <asp:Panel runat="server" ID="pnSubmitStudentMarkButtom">
                <div class="ExamResultEntry-container">
                    <div class="div-margin">
                        <div class="loadArea">
                            <div class="SpecialForButton">
                                <asp:Button ID="btnSubmitAllStudentMarkButtom" runat="server" Text="Save All Student Marks" class="button-margin btn-size1 floatLeft" OnClick="SubmitAllStudentMark_Click" />
                                <asp:Button ID="btnFinalSubmitBottom" runat="server" Text="Final Submit" class="button-margin btn-size1 floatRight" OnClick="FinalSubmit_Click" OnClientClick="if (!confirm('Are you sure you want to Final Submit?')) return false;" />
                                <div class="cleaner"></div>
                            </div>
                        </div>
                    </div>
    ...
    <%--<asp:Panel ID="rptPanel" Visible="false" runat="server">--%>
        <div>&nbsp;</div>

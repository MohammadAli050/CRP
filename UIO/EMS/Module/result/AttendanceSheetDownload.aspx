<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="AttendanceSheetDownload.aspx.cs" Inherits="EMS.Module.Result.AttendanceSheetDownload" %>
                        ...
                        <div class="loadArea">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddlExamCenter" class="margin-zero dropDownList" Width="226px" AutoPostBack="true" OnSelectedIndexChanged="ddlExamCenter_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                            ...
                            <table>
                                <tr>
                                    <td class="auto-style1">
                                        ...
                                        <asp:Button runat="server" ID="btnGenerateAttendanceSheet" Text="Attendance Sheet Generate" OnClick="btnGenerateAttendanceSheet_Click" OnClientClick="return CheckDropdown();" Width="209px" />
                                    </td>
                                    <td class="auto-style1">&nbsp</td>
                                    <td class="auto-style8" style="visibility:hidden"><b>Institution</b></td>

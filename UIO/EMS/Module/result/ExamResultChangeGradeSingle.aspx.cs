...
{
    public partial class ExamResultChangeGradeSingle : BasePage
    {
        #region Function
        ...
        protected void gvExamResultSubmit_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if (ddlStatus2.SelectedItem.Text == "Absent")
                {
                    txtMark2.Text = "ab";
                ...
                if (ddlStatus3.SelectedItem.Text == "Absent")
                {
                    txtMark3.Text = "ab";
                ...
                if (ddlStatus4.SelectedItem.Text == "Absent")
                {
                    txtMark4.Text = "ab";
                ...
                if (ddlStatus5.SelectedItem.Text == "Absent")
                {
                    txtMark5.Text = "ab";
                ...
                if (ddlStatus6.SelectedItem.Text == "Absent")
                {
                    txtMark6.Text = "ab";
                ...
                if (ddlStatus7.SelectedItem.Text == "Absent")
                {
                    txtMark7.Text = "ab";

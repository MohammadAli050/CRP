<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" CodeBehind="StudentCourseDrop.aspx.cs" Inherits="EMS.miu.result.StudentCourseDrop" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Student Course Drop</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    <div>
        ...
        <label>Student Course Drop</label>
        </div>
            ...
            <ContentTemplate>
                <div class="StudentGradeChange-container">
                    <div class="div-margin">
                        <div class="loadArea">
                            <label style="color:blue"><b>**Only Running Courses can be dropped from this page without Bill refund or adjustment**</b></label>
                            </br></br>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="GradeSheetDownloadNew.aspx.cs" Inherits="EMS.Module.result.GradeSheetDownloadNew" %>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="auto-style1">
                                        ...
                                        <asp:Button runat="server" ID="btnGenerateGradeSheet" Text="Grade Sheet Generate" OnClick="btnGenerateGradeSheet_Click" OnClientClick="jsShowHideProgress();" Width="209px" />
                                    </td>
                                </tr>
                            </table>
                        </div>

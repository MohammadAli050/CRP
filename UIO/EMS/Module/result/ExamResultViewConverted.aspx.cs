...
{
    public partial class ExamResultViewConverted : BasePage
    {
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListItem examItem in cblExamList.Items)
            {
                ...
                {
                    List<ExamMarkNewDTO> studentList2 = ExamMarkDetailsManager.GetConvertedExamMarkForReport(programId, sessionId, courseId, versionId, acaCalSectionId, Convert.ToInt32(examItem.Value));
            ...
            try
            {
                ...
                {
                    ResultView.LocalReport.ReportPath = Server.MapPath("~/miu/result/ConvertedExamMarkView.rdlc");

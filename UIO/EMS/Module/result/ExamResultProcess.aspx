<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true"
    CodeBehind="ExamResultProcess.aspx.cs" Inherits="EMS.Module.result.ExamResultProcess" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Exam Result Process</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    ...
    <div class="PageTitle">
        <label>Exam Result Process</label>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2" style="margin-top: 5px">
                            <br />
                            <asp:Button ID="btnProcess" runat="server" Text="Process" OnClick="btnProcess_Click" OnClientClick="jsShowHideProgress();" CssClass="btn btn-info form-control" />
                        </div>
                    </div>
                </div>
            </div>

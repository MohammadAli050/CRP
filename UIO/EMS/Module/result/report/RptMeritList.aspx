<%@ Page Title="Student Merit List" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptMeritList.aspx.cs" Inherits="EMS.miu.result.report.RptMeritList" %>
...
<div>
        <div class="PageTitle">
            <label>Student Merit List</label>
        </div>

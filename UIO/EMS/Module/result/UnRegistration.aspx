<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="UnRegistration.aspx.cs" Inherits="EMS.Module.result.UnRegistration" %>
            ...
            <div class="Message-Area">
                <div class="loadArea">
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label5" runat="server" Font-Bold="true" ForeColor="Blue" Text="1. If Marks exist, you cannot Un-Register the Course. At First, you need to Delete the Marks."></asp:Label></td>
                            <td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label6" runat="server" Font-Bold="true" ForeColor="Blue" Text="2. If Attendance exist, you cannot Un-Register the Course. At First, you need to Delete the Attendance."></asp:Label></td>
                            <td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label7" runat="server" Font-Bold="true" ForeColor="Blue" Text="3. If Grade exist, you cannot Un-Register the Course."></asp:Label></td>
                            <td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label8" runat="server" Font-Bold="true" ForeColor="Blue" Text="4. Once Marks and Attendance are deleted, you cannot restore again, So be careful before delete."></asp:Label></td>
                            <td>

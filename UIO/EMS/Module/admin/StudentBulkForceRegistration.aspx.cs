...
{
    public partial class StudentBulkForceRegistration : BasePage
    {
        ...
        protected void btnStudentButton_Click(object sender, EventArgs e)
        {
            try
            {
                List<LogicLayer.BusinessObjects.Student> studentList = StudentManager.GetAllByProgramIdBatchId(Convert.ToInt32(ucProgram.selectedValue), Convert.ToInt32(ucBatch.selectedValue));
                if (studentList != null)
                {
        ...
        protected void btnLoadOfferedCourse_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<LogicLayer.BusinessObjects.OfferedCourse> offeredCourseList = OfferedCourseManager.GetAllByProgramIdAcaCalId(Convert.ToInt32(ucProgram.selectedValue), Convert.ToInt32(ucSession.selectedValue));

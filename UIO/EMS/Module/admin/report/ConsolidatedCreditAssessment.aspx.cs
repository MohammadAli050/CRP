...
{
    public partial class ConsolidatedCreditAssessment : BasePage
    {
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            List<rFinalMeritList> stdList = ReportManager.GetConsolidatedCreditAssessmentByProgramIDAndSessionRange(programId, fromSessionId, toSessionId,credit);
            ...
            MeritListRptViewer.LocalReport.ReportPath = Server.MapPath("~/miu/admin/report/RptConsolidatedCreditAssessment.rdlc");

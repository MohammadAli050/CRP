<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="StudentForceRegAnyTree.aspx.cs" Inherits="EMS.miu.admin.StudentForceRegAnyTree" %>

<%@ Register Src="~/UserControls/SessionUserControl.ascx" TagPrefix="uc1" TagName="SessionUserControl" %>
<%@ Register Src="~/UserControls/ProgramUserControl.ascx" TagPrefix="uc1" TagName="ProgramUserControl" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" Runat="Server">
    Student Force Registration (Any Tree)
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
    <div class="PageTitle">
        <label>Student Force Registration(Any Tree)</label>
    </div>
            ...
            <div class="Message-Area">
                <div style="padding: 5px; margin: 5px;  width: 900px;">
                    <table>
                        ...
                        <tr>
                            <td class="auto-style2">
                                <asp:Label ID="Label2" runat="server" Width="130px" Text="Program"></asp:Label>
                            </td>
                            <td>
                                <uc1:ProgramUserControl runat="server" ID="ucProgram" class="margin-zero dropDownList" OnProgramSelectedIndexChanged="OnProgramSelectedIndexChange"/>
                            </td>
                        </tr>

                        <tr>
                            <td class="auto-style2">
                                <asp:Label ID="Label3" runat="server" Width="130px" Text="Tree"></asp:Label>
                            </td>
                            <td class="auto-style4">   
                                <asp:DropDownList ID="ddlTree" runat="server" Width="200px" OnSelectedIndexChanged="ddlTree_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">
                                <asp:Label ID="Label4" runat="server" Width="130px" Text="Course"></asp:Label>
                            </td>
                            <td class="auto-style4">   

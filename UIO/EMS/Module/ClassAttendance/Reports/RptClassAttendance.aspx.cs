...
namespace EMS.Attendance.Report
{
    public partial class RptClassAttendance : BasePage
    {
        int userId = 0;
            ...
            try
            {
                ...
                if (user != null)
                {
                    ...
                    if (user.Person != null)
                    {
                        ...
                        if (empObj != null && uapObj.IsAllCourse != true && userRole.RoleName != "Coordinator")
                        {
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            if (ddlAcaCalSection.SelectedItem.Value == "0" || ucSession.selectedValue == "0")
            {
                return;
            }
            ...
            try
            {
                List<rClassAttendance> list = ClassAttendanceManager.GetAttendanceReportByAcaCalSection(acaCalSectionId, attendanceFromDate, attendanceToDate);
                ...
                if (list != null && list.Count > 0)
                {
                    ...
                    ClassAttendance.LocalReport.ReportPath = Server.MapPath("~/miu/ClassAttendance/Reports/RptClassAttendance.rdlc");
                    ReportDataSource rds = new ReportDataSource("ClassAttendanceDataSet", list);
                    ...
                    //parameters[3] = new ReportParameter("TotalMark", txtTotalMark.Text);
                    ...
                    parameters[6] = new ReportParameter("FromDate", txtAttendanceFromDate.Text);
                    parameters[7] = new ReportParameter("ToDate", txtAttendanceToDate.Text);
                    parameters[8] = new ReportParameter("PrintDate", DateTime.Now.ToString("dd/MM/yyyy"));
                    ClassAttendance.LocalReport.DataSources.Clear();

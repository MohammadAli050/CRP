<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" CodeBehind="ClassAttendanceEntry.aspx.cs" Inherits="ClassAttendanceEntry" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    <div style="width:54%; float:right">
                        <asp:Button ID="btnSaveAll" runat="server"  Text="Save" OnClick="btnSave_Click" Width="190px" Height="30px" Visible="false"/>
                    </div>
                    <asp:GridView ID="gvStudentlists" runat="server" AutoGenerateColumns="False" ShowFooter="True" Width="60%">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Roll" Visible ="false" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblStudentId" Width="75px" Font-Bold="True" Text='<%#Eval("StudentId") %>' />
                                    <asp:Label runat="server" ID="lblAcaCalSecId" Width="75px" Font-Bold="True" Text='<%#Eval("AcaCalSectionID") %>' />
                                    <asp:Label runat="server" ID="lblCreatedBy" Width="75px" Font-Bold="True" Text='<%#Eval("CreatedBy") %>' />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Left">
                                <HeaderTemplate>
                                    <asp:RadioButtonList ID="rdoStatusAll" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdoHeaderIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Value="1">Present All</asp:ListItem>
                                        <asp:ListItem Value="2">Absent All</asp:ListItem>
                                    </asp:RadioButtonList>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:RadioButtonList ID="rdoStatus" runat="server" RepeatDirection="Horizontal" SelectedValue='<%#Bind("StatusID")%>'>
                    ...
                    <div style="width:54%; float:right">
                        <asp:Button ID="Button1" runat="server"  Text="Save" OnClick="btnSave_Click" Width="190px" Height="30px" Visible="false"/>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
        </center>

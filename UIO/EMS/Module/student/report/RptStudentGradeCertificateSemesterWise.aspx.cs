...
{
    public partial class RptStudentGradeCertificateSemesterWise : BasePage
    {
            ...
            try
            {
                ...
                if (semesterId != 0 && isChecked != 0)
                {
                    ...
                    foreach (ListItem item in ddlStudentList.Items)
                    {
                        ...
                        {
                            count++;
                            LoadGradeCertificate(item.Value, semesterId, isChecked, count);
                        }
                    }
        ...
        private void LoadGradeCertificate(string roll, int semesterId, int isChecked, int count)
        {
            try
            {
                ...
                if (student != null)
                {
                    ...
                    List<StudentGrade> StudentGradeList = ExamMarkManager.GetGradeReportByRollSemesterNo(roll, semesterId);
                    ...
                    List<rStudentGradeCertificateInfo> studentGeneralInfo = StudentManager.GetStudentGradeCertificateInfoByRoll(student.Roll, 0, semesterId);
                    ...
                    if (studentGeneralInfo != null && studentGeneralInfo.Count > 0)
                    {
                        ...
                        SemesterInfo = ddlSemester.SelectedItem.Text + " " + studentGeneralInfo[0].SemesterInfo;
                    ...
                    if (CreditGPAList != null && CreditGPAList.Count > 0)
                    {
                        ...
                        if (list[0].Sl > 8 || (list[0].RValue.ToString() == "0" && list[1].RValue.ToString() == "0"))
                        {
                            Credit1 = "-";
                            GPA1 = "-";
                        }
                    ...
                    if (StudentGradeList.Count != 0)
                    {
                        ...
                        param1.Add(new ReportParameter("SemesterNo", "1"));
                    ...
                    {
                        ShowMessage("No Data Found for this session!");
                        StudentGradeReport.Visible = false;
                    }
                }
                else
        ...
        protected void ddlSemester_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                List<StudentRollOnly> stdList = StudentManager.GetStudentListRollByProgramBatchSemesterInstitution(semesterId, programId, batchId,institutionId);

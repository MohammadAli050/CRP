<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptStudentGradeBySession.aspx.cs" Inherits="EMS.miu.student.report.RptStudentGradeBySession" %>
            ...
            <ContentTemplate>            
                <div>
                    <table>
                        <tr>
                            <td><b>Program : </b></td>
                            <td class="auto-style8"><uc1:ProgramUserControl runat="server" ID="ucProgram" OnProgramSelectedIndexChanged="OnProgramSelectedIndexChanged"/></td>
                            <td class="auto-style10">&nbsp;</td>
                            
                            <td><b>Batch : </b></td>
                            <td class="auto-style11">
                                <asp:DropDownList ID="ddlBatch" runat="server" Width="100px" OnSelectedIndexChanged="OnBatchSelected_IndexChanged" AutoPostBack="true"/>
                            </td>
                            <td class="auto-style1">
                                <b>Roll : </b>
                            </td>
                            <td class="auto-style2">
                                <asp:DropDownList ID="ddlStudentRoll" runat="server" Width="120px" OnSelectedIndexChanged="OnRollSelected_IndexChanged" AutoPostBack="true"/>
                            </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptStudentGradeCertificateSessionWise.aspx.cs" Inherits="EMS.Module.student.report.RptStudentGradeCertificateSessionWise" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    <div class="PageTitle">
        <label>Student Grade Certificate :: Academic Session Wise</label>
    </div>
                            ...
                            <table style="height: 80px">
                                <tr>
                                    ...
                                    <td class="auto-style8">
                                        <div id="Div1" runat="server" style="height: 80px; width: 150px; overflow-y: auto">
                                    ...
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text="Publication Date" Width="107px"></asp:Label>
                                    </td>
                                    <td>
                                        <div class="controls">
                                    ...
                                    <td class="auto-style5"></td>
                                    <td>
                                        <asp:Label ID="Label3" runat="server" Text="Issued on Date" Width="102px"></asp:Label>
                                    </td>
                                    <td>
                                        <div class="controls">

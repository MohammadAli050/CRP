<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptStudentExamRoutine.aspx.cs" Inherits="EMS.miu.student.report.RptStudentExamRoutine" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    <div class="PageTitle">
        <label>Exam Routine :: Student Wise</label>
    </div>
    ...
    <div>&nbsp;</div>
    <rsweb:reportviewer ID="StudentExamRoutine" runat="server"  waitmessagefont-names="Verdana" waitmessagefont-size="14pt" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" asynrendering="true" Width="78.7%" Height="100%" sizetoreportcontent="true" >
    </rsweb:reportviewer>

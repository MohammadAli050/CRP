<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="RptStudentTranscriptNew2" Codebehind="RptStudentTranscriptNew2.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
    <div class="PageTitle">
        <label>Student Complete Transcript New :: Roll Wise</label>
    </div>
    ...
    <div>&nbsp;</div>        
    <div> 
        <rsweb:reportviewer id="ReportViewer1" runat="server"  waitmessagefont-names="Verdana" waitmessagefont-size="14pt" asynrendering="true" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" Width="55.6%" Height="100%" sizetoreportcontent="true">
        </rsweb:reportviewer>
    </div>

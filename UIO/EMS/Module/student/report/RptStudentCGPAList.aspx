<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="Report_RptStudentCGPAList" Codebehind="RptStudentCGPAList.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
    <%--<div class="PageTitle">
        <label>Student CGPA :: Roll Wise</label>
    </div>--%>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div>
                    <table>
                        <tr>
                            <td style="letter-spacing: 2px; font-weight: bold;" class="auto-style1">Student Roll : </td>
    ...
    <div>&nbsp;</div>
    <div> 
        <rsweb:reportviewer id="ReportViewer1" runat="server"  waitmessagefont-names="Verdana" waitmessagefont-size="14pt" asynrendering="true" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" width="54.8%" Height="100%" sizetoreportcontent="true">
            <%--<LocalReport ReportPath="miu/student/report/RptStudentCGPAList.rdlc">
            </LocalReport>--%>
        </rsweb:reportviewer>
    </div>

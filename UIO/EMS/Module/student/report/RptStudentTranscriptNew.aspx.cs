...
public partial class RptStudentTranscriptNew : BasePage
{
    ...
    private void LoadStudent(string studentId)
    {
        ...
        if (list.Count != 0)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/miu/student/report/RptStudentTranscriptNew.rdlc");

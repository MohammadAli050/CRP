<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="Report_RptCourseListByProgram" Codebehind="RptCourseListByProgram.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" Runat="Server">
    <div class="PageTitle">
        <label>Course List :: Program Wise</label>
    </div>
                    ...
                    <table>
                        <tr>                                
                            ...
                            <td style="width: 120px;">
                                <asp:Button ID="btnLoad" runat="server" OnClick="btnLoad_Click" Text="Load" Width="100px" CssClass="pointer"  Height="25px"/>
                            </td>                           
                        </tr>
                    </table>
                </div>
    ...
    <div>&nbsp;</div>
    <div> 
        <rsweb:reportviewer id="ReportViewer1" runat="server"  waitmessagefont-names="Verdana" waitmessagefont-size="14pt" asynrendering="true" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" width="43%" Height="100%" sizetoreportcontent="true">
            <%--<LocalReport ReportPath="miu/student/report/RptCourseListByProgram.rdlc">
            </LocalReport>--%>
        </rsweb:reportviewer>
    </div> 

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" CodeBehind="RptStudentResultSemesterWise.aspx.cs" Inherits="EMS.miu.student.report.RptStudentResultSemesterWise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="Server">Student GPA & CGPA List</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
    <div>
        <div class="PageTitle">
            <label>Student GPA & CGPA List</label>
        </div>

...
public partial class StudentBlock : BasePage
{
    ...
    protected void btnLoad_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                LoadStudent(programId, batchId, roll, registrationSession, sessionUpto, amountFrom, amountTo);
            }
        }
        catch (Exception)
        {
    ...
    private void LoadStudent(int programId, int batchId, string roll, int registrationSession, int dueUptoSession, decimal amountFrom, decimal amountTo)
    {
        // List<Student> studentList = StudentManager.GetAllByProgramOrBatchOrRoll(programId, acaCalId, roll);
        List<PersonBlockDTO> studentList = PersonBlockManager.GetAllByProgramOrBatchOrRoll(programId, batchId, roll,registrationSession, dueUptoSession);

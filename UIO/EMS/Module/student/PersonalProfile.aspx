<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="PersonalProfile.aspx.cs" Inherits="PersonalProfile" %>
                    ...
                    <ContentTemplate>
                        <div class="div-margin">
                            <div class="information-Zone">
                                ...
                                <div class="loadedAreaOdd">
                                    <label class="display-inline field-Title">Exam Center</label>
                                ...
                                <div class="loadedAreaOdd">
                                    <label><b>SMS Contact Self <font color="red">(Format: +880**********)</b></font></label>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="StudentPictureEdit.aspx.cs" Inherits="StudentPictureEdit" %>
    ...
    <div>
        ...
        <div class="personalProfile-container">
            ...
            <asp:Panel runat="server" ID="pnIsVisible">
                ...
                <br /><br /><h4><span>Student Name:  </span><asp:Label runat="server" ID="StdName" Enabled="True" /></h4>
                <asp:UpdatePanel ID="UpdatePanel02" runat="server">
                    <ContentTemplate>
                        <div class="div-margin"  hidden="hidden">
                            <div class="information-Zone">
                                ...
                                <div class="loadedAreaOdd">
                                    ...
                                    <asp:DropDownList runat="server" Enabled="false" ID="ddlGender" class="margin-zero dropDownList">
                                ...
                                <div class="loadedAreaEven">
                                    ...
                                    <asp:DropDownList runat="server"  Enabled="false" ID="ddlBloodGroup" class="margin-zero dropDownList">
                                        <asp:ListItem Value="">Select</asp:ListItem>
                                ...
                                <div class="loadedAreaOdd">
                                    ...
                                    <asp:TextBox runat="server" ID="txtPhone"  Enabled="false" class="margin-zero input-Size" placeholder="Phone / Mobile Number" />
                                </div>

                                <div class="loadedAreaEven">
                                    <label class="display-inline field-Title">Nationality</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtNationality" class="margin-zero input-Size" />
                                </div>
                                <div class="loadedAreaOdd">
                                    <label class="display-inline field-Title">Father</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtFatherName" class="margin-zero input-Size" placeholder="Father's Name" />
                                </div>
                                <div class="loadedAreaEven">
                                    <label class="display-inline field-Title">Mother</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtMotherName" class="margin-zero input-Size" placeholder="Mother's Name" />
                                </div>
                                <div class="loadedAreaOdd">
                                    <label>SMS Contact Self <font color="red">(Format: +880**********)</font></label>
                                    <asp:TextBox runat="server" Enabled="false"  ID="txtSMSContactSelf" class="margin-zero input-Size" placeholder="Phone / Mobile Number" />
                                    <asp:RegularExpressionValidator Enabled="false"  ID="RegularExpressionValidator1" runat="server"
                                ...
                                <div class="loadedAreaOdd">
                                    <label>SMS Contact Gaurdian <font color="red">(Format: +880**********)</font></label>
                                    <asp:TextBox runat="server" Enabled="false"  ID="txtSMSContactGuardian" class="margin-zero input-Size" placeholder="Phone / Mobile Number" />
                            ...
                            <div class="information-Zone">
                                <div class="loadAreaEven">
                                    ...
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtDOB" class="margin-zero input-Size1 datepicker" DataFormatString="{0:dd/MM/yyyy}" />
                                    <ajaxToolkit:CalendarExtender ID="reqSubmissionStart" runat="server" TargetControlID="txtDOB" Format="dd/MM/yyyy" />
                                </div>
                                <div class="loadedAreaEven">
                                    <label class="display-inline field-Title">Matrial Status</label>
                                    <asp:DropDownList runat="server"  Enabled="false" ID="ddlMatrialStatus" class="margin-zero dropDownList">
                                        <asp:ListItem Value="">Select</asp:ListItem>
                                ...
                                <div class="loadedAreaEven">
                                    ...
                                    <asp:TextBox runat="server" Enabled="false"  ID="txtEmail" class="margin-zero input-Size" placeholder="Email Address" />
                                </div>
                                <div class="loadedAreaOdd">
                                    <label class="display-inline field-Title">Guardian</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtGuardianName" class="margin-zero input-Size" placeholder="Guardian's Name" />
                                </div>
                                <div class="loadedAreaEven">
                                    <label class="display-inline field-Title">Profession</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtFatherProfession" class="margin-zero input-Size" placeholder="Father's Profession" />
                                </div>
                                <div class="loadedAreaOdd">
                                    <label class="display-inline field-Title">Profession</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtMotherProfession" class="margin-zero input-Size" placeholder="Mother's Profession" />
                                </div>
                            </div>
                            <div class="information-Zone">
                                ...
                                <div class="loadAreaOdd">
                                    ...
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtPresent" class="margin-zero input-Size2" TextMode="MultiLine" placeholder="Present Address" />
                                </div>
                                <div class="loadedAreaOdd">
                                    <label class="display-inline field-Title2">Permanent</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtPermanent" class="margin-zero input-Size2" TextMode="MultiLine" placeholder="Permanent Address" />
                                </div>
                                <div class="loadedAreaEven">
                                    <label class="display-inline field-Title2">Guardian</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtGuardian" class="margin-zero input-Size2" TextMode="MultiLine" placeholder="Guardian Address" />
                                </div>
                                <div class="loadedAreaOdd">
                                    <label class="display-inline field-Title2">Mailing</label>
                                    <asp:TextBox runat="server"  Enabled="false" ID="txtMailing" class="margin-zero input-Size2" TextMode="MultiLine" placeholder="Mailing Address" />
                                </div>
                            </div>

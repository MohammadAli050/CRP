<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="StudentAdmitCardUnBlock" CodeBehind="StudentAdmitCardUnBlock.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
    <div style="padding: 5px; width: 100%;">
        <div class="PageTitle">
            <label>Student Admit Card Unblock</label>
        </div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Registration Block" >
                                <HeaderTemplate>
                                    ...
                                    <hr />
                                    <asp:CheckBox Enabled="false" ID="chkSelectAllRegistrationBlock" runat="server" Text="All"
                                        AutoPostBack="true" OnCheckedChanged="chkSelectAllRegistrationBlock_CheckedChanged" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div style="text-align: center">
                                        <asp:CheckBox Enabled="false" runat="server" ID="ChkIsRegistrationBlock" Checked='<%#Eval("IsRegistrationBlock") %>'></asp:CheckBox>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle Width="140px" />
                            </asp:TemplateField>

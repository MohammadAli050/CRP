<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="StudentRegistrationUnBlock" CodeBehind="StudentRegistrationUnBlock.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
    <div style="padding: 5px; width: 100%;">
        <div class="PageTitle">
            <label>Student Registration Unblock</label>
        </div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Admit Card Block">
                                <HeaderTemplate>
                                    ...
                                    <hr />
                                    <asp:CheckBox Enabled="false" ID="chkSelectAllAdmitCardBlock" runat="server" Text="All"
                                        AutoPostBack="true" OnCheckedChanged="chkSelectAllAdmitCardBlock_CheckedChanged" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div style="text-align: center">
                                        <asp:CheckBox Enabled="false" runat="server" ID="ChkIsAdmitCardBlock" Checked='<%#Eval("IsAdmitCardBlock") %>'></asp:CheckBox>
                                    </div>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Registration Block">
                             ...
                             <asp:TemplateField HeaderText="Result Block">
                                <HeaderTemplate>
                                    ...
                                    <hr />
                                    <asp:CheckBox  Enabled="false" ID="chkSelectAllResultBlock" runat="server" Text="All"
                                        AutoPostBack="true" OnCheckedChanged="chkSelectAllResultBlock_CheckedChanged" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div style="text-align: center">
                                        <asp:CheckBox  Enabled="false" runat="server" ID="ChkIsResultBlock" Checked='<%#Eval("IsResultBlock") %>'></asp:CheckBox>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle Width="140px" />
                            </asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="Master Block">
                                <HeaderTemplate>
                                    ...
                                    <hr />
                                    <asp:CheckBox Enabled="false" ID="chkSelectAllMasterBlock" runat="server" Text="All"
                                        AutoPostBack="true" OnCheckedChanged="chkSelectAllMasterBlock_CheckedChanged" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div style="text-align: center">
                                        <asp:CheckBox Enabled="false" runat="server" ID="ChkIsMasterBlock" Checked='<%#Eval("IsMasterBlock") %>'></asp:CheckBox>
                                    </div>
                                </ItemTemplate>
                                <HeaderStyle Width="140px" />
                            </asp:TemplateField>

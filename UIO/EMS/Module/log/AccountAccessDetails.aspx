<%@ Page Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="AccountAccessDetails.aspx.cs" Inherits="EMS.miu.log.AccountAccessDetails" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    <div>
        <div class="PageTitle">
            <label>Account Access Log</label>
        </div>
                ...
                <ContentTemplate>
                    <div class="div-margin">
                        ...
                        <div class="loadedArea" style="margin-top:10px">
                            <label class="display-inline field-Title">Login ID :</label>
                            <asp:TextBox runat="server" ID="txtFilterLoginID" class="margin-zero label-width" />

                            <label class="display-inline field-Title">Status :</label>
                            <asp:TextBox runat="server" ID="txtFilterStatus" class="margin-zero label-width" />

                            <label class="display-inline field-Title" style="width:100px;">LogIn/LogOut :</label>
                            <asp:TextBox runat="server" ID="txtFilterInOut" class="margin-zero label-width" />
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel4">
            <ContentTemplate>
                <div>
                    <asp:GridView ID="gvLogInOutGeneral" runat="server" AutoGenerateColumns="False" TabIndex="6" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Login ID" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblUser" Text='<%#Eval("LoginID") %>' />
                                </ItemTemplate>
                                <HeaderStyle Width="10px" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Attempts" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblAttempts" Text='<%#Eval("PasswordAttempts") %>' />
                                </ItemTemplate>
                                <HeaderStyle Width="10px" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblStatus" Text='<%#Eval("loginStatus") %>' />
                                </ItemTemplate>
                                <HeaderStyle Width="10px" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="IP Address" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="LogIn/LogOut" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblInOut" Text='<%#Eval("LogInLogOut") %>' />
                                </ItemTemplate>
                                <HeaderStyle Width="10px" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>

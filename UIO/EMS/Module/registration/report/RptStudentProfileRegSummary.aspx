<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptStudentProfileRegSummary.aspx.cs" Inherits="EMS.miu.registration.report.RptStudentRegSummary" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    <div class="PageTitle">
        <label>Class Routine Summary :: Course Wise</label>
    </div>
    ...
    <div>&nbsp;</div>
    <rsweb:reportviewer ID="StudentRegSummary" runat="server"  waitmessagefont-names="Verdana" waitmessagefont-size="14pt" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" asynrendering="true" Width="54.2%" Height="100%" sizetoreportcontent="true" >
            <%--<LocalReport ReportPath="miu/student/report/RptStudentRegSummary.rdlc">
            </LocalReport>--%>
    </rsweb:reportviewer>

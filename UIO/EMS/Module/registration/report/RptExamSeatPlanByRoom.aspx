<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="RptExamSeatPlanByRoom.aspx.cs" Inherits="EMS.miu.registration.report.RptExamSeatPlan" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="server">
    <div class="PageTitle">
        <label>Exam Seat plan :: Room Wise</label>
    </div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:DropDownList runat="server" ID="ddlCalenderType" Width="100"  AutoPostBack ="true" OnSelectedIndexChanged="CalenderType_Changed" />
                            </td>        
                            <td>
                                <asp:Label ID="lblTrees" Font-Bold="true" runat="server" Text="Session:"></asp:Label>
                            </td>
                            <td class="auto-style2">
                                <asp:DropDownList runat="server" ID="ddlAcademicCalender" Width="140" AutoPostBack ="true" OnSelectedIndexChanged="AcademicCalender_Changed" />
                            </td>
                            <td>
    ...
    <div>&nbsp;</div>
    <rsweb:ReportViewer ID="ExamSeatPlan" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" asynrendering="true" BackColor="Wheat" BorderColor="WhiteSmoke" BorderStyle="Solid" BorderWidth="1" CssClass="center" Height="100%" Width="51.3%" SizeToReportContent="true">      
        <%--<LocalReport ReportPath="miu/registration/report/RptExamSeatPlanByRoom.rdlc">
        </LocalReport>--%>
    </rsweb:ReportViewer>
</asp:Content>

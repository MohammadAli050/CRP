...
public partial class RptRegisterdStudentList : BasePage
{
    ...
    protected void buttonView_Click(object sender, EventArgs e)
    {
        ...
        {
            LoadRunningStudentCourseList(programId, acaCalId, 0);
        }
        else {
    ...
    private void LoadRunningStudentCourseList(int programId, int acaCalId, int batchId)
    {
        ...
        if (list.Count != 0)
        {
            ...
            RegisteredCourses.LocalReport.ReportPath = Server.MapPath("~/miu/registration/report/RptRegisterdStudentList.rdlc");

...
public partial class AutoOpenCourse : BasePage
{
        ...
        try
        {
            foreach (GridViewRow row in gvStudentList.Rows)
            {
                ...
                if (ckBox.Checked)
                {
                    ...
                    rwParam.AcademicCalenderID = student.BatchId;

                    rwParam.CrOpenLimit = 0;
    ...
    private void LoadGridFromSession()
    {
        ...
        _studentListWithCGPA = SessionManager.GetListFromSession<Student>("_studentList");

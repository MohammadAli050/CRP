...
public partial class Admin_RequisitionByCourse : BasePage
{
    List<Course> courseList;
    List<RegistrationWorksheet> regWork;
    ...
    protected void loadButton_Click(object sender, EventArgs e)
    {
        ...
        regWork = RegistrationWorksheetManager.GetReqByCourse(courseId,versionId);
        ...
        if (ID != "")
        {
            // regWork = RegistrationWorksheetManager.GetReqByProgCal(Convert.ToInt32(programListCombo.SelectedValue), Convert.ToInt32(batchListCombo.SelectedValue));

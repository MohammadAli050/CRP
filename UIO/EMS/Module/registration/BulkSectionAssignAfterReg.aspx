<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" CodeBehind="BulkSectionAssignAfterReg.aspx.cs" Inherits="EMS.miu.registration.BulkSectionAssignAfterReg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="Server">
    Bulk Section Assign After Registration
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
    <div style="padding: 5px; width: 100%;">
        <div class="PageTitle">
            <label>Student Bulk Section Assign After Registration</label>
        </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView runat="server" ID="gvStudentList" AutoGenerateColumns="False" AllowPaging="false" PageSize="20"
                        ...
                        <Columns>
                           <asp:TemplateField HeaderText="CourseHistoryId" Visible="false">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblCourseHistoryId" Text='<%#Eval("ID") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle />
                            </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="AutoAssignCourse" Codebehind="AutoAssignCourse.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContainer" runat="Server">
    <div style="padding: 10px; width: 1200px;">
        ...
        <%--<div class="PageTitle">
            <label>Auto Assign Course</label>
        </div>--%>
                ...
                <ContentTemplate>
                    <table style="padding: 1px; width: 1070px;">
                        <tr>
                            <td>Batch</td>
                            <td>
                                <asp:DropDownList ID="ddlAcaCalBatch" DataValueField="AcademicCalenderID" DataTextField="FullCode" runat="server" Width="140px">
                                </asp:DropDownList></td>
                            <td>Program</td>
                            <td>
            ...
            <div style="padding: 1px; margin-top: 20px;">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView runat="server" ID="gvStudentList" AutoGenerateColumns="False" AllowPaging="false" PageSize="20" Width="100%"
                           ...
                           <HeaderStyle BackColor="#737CA1" ForeColor="White" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lable_3" runat="server" Text="Auto Pre-reg Cr." Width="130">
                                        </asp:Label>
                                        <br />
                                        <hr style="width: 100px" />
                                        <asp:TextBox ID="txtAutoPreregCr" Width="50" runat="server">
                                        </asp:TextBox>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <div style="text-align: center">
                                            <asp:Label runat="server" ID="lblAutoPreRegCr" Text='<%#Eval("AutoPreRegCr") %>'></asp:Label>
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle Width="130px" />
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Button ID="btnAutoPreReg" runat="server" Height="45px" Text="Assign Course"
                                            OnClick="btnAutoPreReg_Click" Font-Bold="True" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <div style="text-align: center">
                                            <asp:Label runat="server" ID="lblAutoPreReg" Font-Bold="true" Text='<%#Eval("AutoPreReg") %>'></asp:Label>
                                        </div>
                                    </ItemTemplate>

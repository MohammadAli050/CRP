<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationBill.aspx.cs" Inherits="EMS.Bill.RegistrationBill" MasterPageFile="~/MasterPage/Bill/Bill.Master" %>
                                        ...
                                        <tr>  
                                            ...
                                            <td>                                                            
                                                <asp:Button ID="btnSave" runat="server" Height="25px" onclick="btnSave_Click" 
                                                    Text="Generate Bill" Width="124px" CssClass="button" />                                                                                                            
                                            </td>
                                            <td>                                                    

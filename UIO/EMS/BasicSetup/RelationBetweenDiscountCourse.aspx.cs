...
public partial class BasicSetUp_RelationBetweenDiscountCourse : BasePage
{
    ...
    protected void btnLoad_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            _typeDefs = TypeDefinition.GetTypes("Course");
            ...
            #endregion
            List<RelationDiscountCourseEntity> sdes = BussinessObject.RelationDiscountCourse_BAO.GetRelations(Int32.Parse(cboAcaCalender.SelectedItem.Value.ToString()), Int32.Parse(cboProgram.SelectedItem.Value.ToString()));                
                ...
                foreach (TypeDefinition td in _typeDefs)
                {
                    ...
                    if (sdes != null)
                    {
                        var dsc = from res in sdes
                                  ...
                                  && res.TypeDefCourseID == td.Id
                                  select res.TypeDefCourseID;
                        if (dsc.Count() > 0)
                        {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            List<RelationDiscountCourseEntity> sds = new List<RelationDiscountCourseEntity>();
                    ...
                    foreach (DataControlField col in gvDiscount.Columns)
                    {
                        ...
                        if (col.HeaderText == td.Definition)
                        {
                            ...
                            if (chkBox.Checked)
                            {
                                ...
                                sd.TypeDefCourseID = Int32.Parse(txtBox.Text.Trim());
                                break;
                            }
                        }
                    }
                    if (sd.TypeDefCourseID != 0)
                    {
            ...
            if (BussinessObject.RelationDiscountCourse_BAO.Save(sds) != 0)
            {

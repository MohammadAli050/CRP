<%@ Page Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="BasicSetUp_RelationBetweenDiscountCourse" Codebehind="RelationBetweenDiscountCourse.aspx.cs" %>
                ...
                <tr>
                    <td style="width: 250px; height: 25px;" class="td">
                        <asp:label ID="lblHeader" runat="server" Font-Bold="True" ForeColor="#000099" 
                                        Width="250px">Relation Between Discount and Course</asp:label>
                    </td>

<%@ Page Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Inherits="StudentManagement_DiscountEntry" Codebehind="DiscountEntry.aspx.cs" %>
            ...
            <table style="width:980px; height:580px" id="tblHeader">
                <tr>
                    <td style="width: 250px; height: 25px;" class="td">
                        <asp:label ID="lblHeader" runat="server" Font-Bold="True" ForeColor="#000099" 
                                        Width="250px">Discount Entry</asp:label>
                    </td>
                ...
                <tr>
                    <td style="height: 25px">
                        <asp:TextBox ID="txtFind" runat="server" Width="250px" Visible="False"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Button ID="btnFind" runat="server" CssClass="button" Height="25px" 
                                        Text="Find Student" Width="124px" Visible="False" />
                    </td>
                </tr>
                <tr>
                    <td colspan = "2" style="height: 25px">
                        <table>
                            <tr>
                                ...
                                <td style="width: 150px; height: 25px">
                                    <dxe:ASPxComboBox ID="cboEffectiveCal" runat="server" Width="150px" 
                                        Height="25px" DropDownStyle="DropDown" EnableIncrementalFiltering="True" 
                                        TabIndex="6">
                                    </dxe:ASPxComboBox>
                                </td>                     

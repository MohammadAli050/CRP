<%@ Page Language="C#" MasterPageFile="~/MasterPage/Common/CommonMasterPage.master" AutoEventWireup="true" Codebehind="AssignCourseTree.aspx.cs" Inherits="StudentManagement_AssignCourseTree" %>
        ...
        <ContentTemplate>
            <table style="width:980px; height:580px" id="tblHeader">
                <tr >                    
                    <td style="width: 250px; height: 25px;" class="td">
                        <asp:label ID="lblHeader" runat="server" Font-Bold="True" ForeColor="#000099" 
                                        Width="250px">Assign Course Tree</asp:label>
                    </td>
                ...
                <tr>                    
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan = "5">
                                    <table>
                                        <tr>  
                                            <td align ="left">Select to Assign a Course Tree to the Selected Student(s)&nbsp;                                         
                                            </td>
                                            <td style="width: 150px; height: 25px">
                                                <dxe:ASPxComboBox ID="cboCourseTree" runat="server" Width="150px" 
                                                    Height="25px" DropDownStyle="DropDown" EnableIncrementalFiltering="True" 
                                                    AutoPostBack="True" ReadOnlyStyle-Font-Italic="true" TabIndex="3">
                                                    <ReadOnlyStyle Font-Italic="True">
                                                    </ReadOnlyStyle>
                                                </dxe:ASPxComboBox>
                                            </td>
                 ...
                 <tr>
                    <td  colspan="2">
                        <table style="height: 24px; width: 960px">
                                <tr style=" color:Aqua">
                                    <td style=" width:90px">
                                        <asp:CheckBox ID="chkAll" Text="Select All" Width="90px" runat="server" 
                                    ...
                                    <td style=" width:250px">
                                        <asp:Label ID="Label2" runat="server" Width = "200px" Text="Name" 
                                            Font-Bold="True"></asp:Label>
                                    </td>
                                    <td style=" width:150px">
                                        <asp:Label ID="Label3" runat="server" Width = "180px" Text="Course Tree Name" 
                                            Font-Bold="True"></asp:Label>
                                    </td>
                                </tr>
                            </table>          
                 ...
                 <tr>
                    <td colspan = "2">
                        <asp:Panel ID="pnlCourseOfferGrid" runat="server" Width="980px" Height="397px" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenCourse.aspx.cs" Inherits="EMS.Registration.OpenCourse" MasterPageFile="~/MasterPage/Registration/Registration.master"%>
        ...
        <ContentTemplate>
            <table style="width:980px; height:580px" id="tblHeader">
                <tr >                    
                    <td style="width: 250px; height: 25px;" class="td">
                        <asp:label ID="lblHeader" runat="server" Font-Bold="True" ForeColor="#000099" 
                                        Width="250px">Course Opening</asp:label>
                    </td>
                ...
                <tr>                    
                                        ...
                                        <tr>  
                                            ...
                                            <td>                                                            
                                                <asp:Button ID="btnSave" runat="server" Height="25px" onclick="btnSave_Click" 
                                                    Text="Open courses" Width="124px" CssClass="button" />                                                                                                            
                                            </td>
                                            <td>                                                    
                 ...
                 <tr>
                    <td  colspan="2"; class="td" >
                        <table style="height: 24px; width: 525px">
                                <tr style=" color:Aqua">
                                    <td style=" width:50px">
                                    ...
                                    <td style=" width:100px">
                                        <asp:Label ID="Label1" runat="server" Width = "90px" Text="Student Roll" 
                    ...
                    <td colspan = "2"; class="td">
                        <asp:Panel ID="pnlCourseOfferGrid" runat="server" Width="100%" Height="397px" 
                            ...
                            <asp:gridview ID="gvwCollection" runat="server" AutoGenerateColumns="False" 
                                Height="120px" TabIndex="6"  ShowHeader="False">
						        <RowStyle Height="24px" />
								    <Columns>
                                        <asp:TemplateField  ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                                <asp:CheckBox ID="chkSelect" runat="server" Text = " Select All " AutoPostBack="true" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
